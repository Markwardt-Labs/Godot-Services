...
(await Script.Run(false, "dotnet", "reportgenerator", $"-reports:{testResultsFolder}/**/coverage.cobertura.xml", $"-targetdir:{testResultsFolder}", "-reporttypes:TextSummary", "-classfilters:-GodotPlugins.Game.Main")).Verify();
