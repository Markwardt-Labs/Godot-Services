...
(await Script.Run(false, "dotnet", "reportgenerator", "-reports:Tests/TestResults/**/coverage.cobertura.xml", "-targetdir:.github/badges", "-reporttypes:Badges", "-classfilters:-GodotPlugins.Game.Main")).Verify();
Script.Delete("Tests/TestResults");
